...
public class FridgeBeer implements Entity{
    ...
    public FridgeBeer(String userId, String beerId, Date addedAt) {
        this.userId = userId;
        this.beerId = beerId;
    ...
    public String toString() {
        return "FridgeBeer(id=" + this.getId() + ", userId=" + this.getUserId() + ", beerId=" + this.getBeerId() + ", addedAt=" + this.getAddedAt() + ")";
    }
}
